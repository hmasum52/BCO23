...
ORG1_ADMIN_USERID="o1admin"
ORG1_ADMIN_PWD="o1adminpw"

ORG2_ADMIN_USERID="o2admin"
ORG2_ADMIN_PWD="o2adminpw"

function createOrg1() {
  infoln "Enrolling the Org1 CA admin"
  mkdir -p organizations/peerOrganizations/org1.example.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/org1.example.com/

  set -x
  fabric-ca-client enroll -u https://${ORG1_ADMIN_USERID}:${ORG1_ADMIN_PWD}@localhost:7054 --caname ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrg2() {
  infoln "Enrolling the Org2 CA admin"
  mkdir -p organizations/peerOrganizations/org2.example.com/

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/peerOrganizations/org2.example.com/

  set -x
  fabric-ca-client enroll -u https://${ORG2_ADMIN_USERID}:${ORG2_ADMIN_PWD}@localhost:8054 --caname ca-org2 --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
  { set +x; } 2>/dev/null
